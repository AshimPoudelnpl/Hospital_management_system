      ...
      <div className="bg-blue-900 text-white py-20 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 text-center relative z-10">
          <img
            ...
            className="w-24 mx-auto mb-6 rounded-full p-3"
          />
          <h1 className="text-5xl font-bold mb-4">About Swastik Hospital</h1>
          <p className="text-blue-200 text-lg max-w-2xl mx-auto">
            Dedicated to excellence in healthcare — serving our community with
            compassion, innovation, and integrity since 2005.
          </p>
          <div className="flex gap-4 justify-center mt-8 flex-wrap">
            ...
            <button
              ...
              className="border border-white text-white px-6 py-3 rounded-lg font-semibold hover:bg-white hover:text-blue-900 transition"
            >
              Contact Us
            </button>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-6">
            {[
              ...
              <div key={i} className="text-center p-6">
                <div
                  className={`text-4xl mb-3 flex justify-center ${stat.color}`}
                >
                  {stat.icon}
                </div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <h2 className="text-4xl font-bold text-blue-900 mt-2 mb-6">
              A Hospital Built on Trust & Compassion
            </h2>
            <p className="text-gray-600 leading-relaxed mb-4">
              Swastik Hospital is a multi-specialty hospital committed to
              providing high-quality, personalized care for patients with
              various medical concerns. With a skilled team led by experienced
              doctors, we bring cutting-edge technology and years of surgical
              and clinical experience to your care.
            </p>
            <p className="text-gray-600 leading-relaxed mb-6">
              Founded in 2005, we have grown from a small clinic to a
              full-fledged hospital serving thousands of patients every year.
              Our state-of-the-art facilities and compassionate staff ensure
              that every patient receives the best possible treatment in a
            ...
            <div className="space-y-3">
              {[
                ...
                "Continuous medical education for our staff",
              ].map((item) => (
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
            {[
              ...
              },
              {
                ...
                desc: "Highly qualified doctors with decades of experience across all medical specialties.",
              },
              {
                icon: <FaMicroscope />,
                title: "Advanced Technology",
                desc: "State-of-the-art diagnostic and treatment equipment for accurate and efficient care.",
              },
              {
                icon: <FaHandHoldingHeart />,
                title: "Compassionate Care",
                desc: "We treat every patient with empathy, dignity, and personalized attention.",
              },
              {
                icon: <FaShieldAlt />,
                title: "Safe & Hygienic",
                desc: "Strict infection control protocols and hygiene standards maintained at all times.",
              },
              {
                icon: <FaBriefcaseMedical />,
                title: "Affordable Pricing",
                desc: "Transparent and reasonable pricing with flexible payment options for all patients.",
              },
            ].map((item, i) => (
              <div
                key={i}
                className="flex items-start gap-4 bg-white/10 rounded-xl p-5"
              >
                <div className="text-2xl text-blue-300 flex-shrink-0 mt-1">
                  {item.icon}
                </div>
                <div>
